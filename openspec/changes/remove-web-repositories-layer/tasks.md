...
- Refactor `useCurrentUser()` to call `apiRequest` directly (if exists)
...
- If other implementations exist (external service adapters), keep directory but document purpose
